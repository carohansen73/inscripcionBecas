...
class Inscription extends Model
{
    ...
    public static $rules = [
        ...
        'student_certificate'  => 'required|mimes:pdf|max:5120',
        'anses_negative'  => 'required|mimes:pdf|max:5120',
    ...
    public static $messages = [
        ...
        'student_certificate.required' => 'El campo certificado de alumno regular es obligatorio.',
        'student_certificate.mimes' => 'El campocertificado de alumno regular debe ser formato pdf.',
        'student_certificate.max' => 'El campo certificado de alumno regular no debe superar los 5 MB.',
        'anses_negative.required' => 'El campo negativa de anses es obligatorio.',
        'anses_negative.mimes' => 'El campo negativa de anses debe ser formato pdf.',
        'anses_negative.max' => 'El campo negativa de anses no debe superar los 5 MB.',
